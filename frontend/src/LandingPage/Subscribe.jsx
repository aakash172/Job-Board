...
const Subscribe = () => {
    return (
        <div className="mt-20 flex items-center bg-mine-shaft-900 mx-20 py-3 rounded-xl justify-around">
            <div className="text-4xl w-2/5  text-center font-semibold text-mine-shaft-100 ">Never wants to miss a
            ...
            <div className='flex gap-4 rounded-xl bg-mine-shaft-700 px-3 py-2 items-center'>
                <TextInput
                    ...
                    size='xl'
                />
                <Button className='!roundedlg' size='lg' color='brightSun.4' variant="filled">Subscribe</Button>
            </div>
        </div>
    );
};
